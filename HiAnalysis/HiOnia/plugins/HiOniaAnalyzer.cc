...
private:
  ...
  float QWZDC_Sum,     QWZDC_SumP,   QWZDC_SumN;
  float QWZDC_emSumP,  QWZDC_emSumN;
  float QWZDC_hadSumP, QWZDC_hadSumN;
  ...
  edm::Handle<double> evHandleZDCSum;     edm::Handle<double> evHandleZDCSumP;  edm::Handle<double> evHandleZDCSumN;
  edm::Handle<double> evHandleZDCemSumP;  edm::Handle<double> evHandleZDCemSumN;
  edm::Handle<double> evHandleZDChadSumP; edm::Handle<double> evHandleZDChadSumN;
  ...
  edm::EDGetTokenT<double>                            _evZDCSumToken;
  edm::EDGetTokenT<double>                            _evZDCSumNToken;
  edm::EDGetTokenT<double>                            _evZDCSumPToken;
  edm::EDGetTokenT<double>                            _evZDCemSumNToken;
  edm::EDGetTokenT<double>                            _evZDCemSumPToken;
  edm::EDGetTokenT<double>                            _evZDChadSumNToken;
  edm::EDGetTokenT<double>                            _evZDChadSumPToken;
...
HiOniaAnalyzer::HiOniaAnalyzer(const edm::ParameterSet& iConfig):
  ...
  _evZDCSumToken(consumes<double>(iConfig.getParameter<edm::InputTag>("evZDCSum"))),
  _evZDCSumNToken(consumes<double>(iConfig.getParameter<edm::InputTag>("evZDCSumN"))),
  _evZDCSumPToken(consumes<double>(iConfig.getParameter<edm::InputTag>("evZDCSumP"))),
  _evZDCemSumNToken(consumes<double>(iConfig.getParameter<edm::InputTag>("evZDCemSumN"))),
  _evZDCemSumPToken(consumes<double>(iConfig.getParameter<edm::InputTag>("evZDCemSumP"))),
  _evZDChadSumNToken(consumes<double>(iConfig.getParameter<edm::InputTag>("evZDChadSumN"))),
  _evZDChadSumPToken(consumes<double>(iConfig.getParameter<edm::InputTag>("evZDChadSumP"))),
...
HiOniaAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  iEvent.getByToken(_evZDCSumToken,     evHandleZDCSum);
  iEvent.getByToken(_evZDCSumNToken,    evHandleZDCSumN);
  iEvent.getByToken(_evZDCSumPToken,    evHandleZDCSumP);
  iEvent.getByToken(_evZDCemSumNToken,  evHandleZDCemSumN);
  iEvent.getByToken(_evZDCemSumPToken,  evHandleZDCemSumP);
  iEvent.getByToken(_evZDChadSumNToken, evHandleZDChadSumN);
  iEvent.getByToken(_evZDChadSumPToken, evHandleZDChadSumP);
 
  QWZDC_Sum     = float(*evHandleZDCSum);
  QWZDC_SumP    = float(*evHandleZDCSumP);
  QWZDC_SumN    = float(*evHandleZDCSumN);
  QWZDC_emSumP  = float(*evHandleZDCemSumP);
  QWZDC_emSumN  = float(*evHandleZDCemSumN);
  QWZDC_hadSumP = float(*evHandleZDChadSumP);
  QWZDC_hadSumN = float(*evHandleZDChadSumN);
...
HiOniaAnalyzer::InitTree()
{
  ...
  myTree->Branch("QWZDC_Sum", &QWZDC_Sum, "QWZDC_Sum/f");
  myTree->Branch("QWZDC_SumP",&QWZDC_SumP,"QWZDC_SumP/f");
  myTree->Branch("QWZDC_SumN",&QWZDC_SumN,"QWZDC_SumN/f");

  myTree->Branch("QWZDC_emSumP",&QWZDC_emSumP,"QWZDC_emSumP/f");
  myTree->Branch("QWZDC_emSumN",&QWZDC_emSumN,"QWZDC_emSumN/f");

  myTree->Branch("QWZDC_hadSumP",&QWZDC_hadSumP,"QWZDC_hadSumP/f");
  myTree->Branch("QWZDC_hadSumN",&QWZDC_hadSumN,"QWZDC_hadSumN/f");
